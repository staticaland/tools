...
- **Load dependencies from CDN**: The fewer dependencies the better, but if there's a well known library that helps solve a problem, load it from CDNjs or jsdelivr or similar
